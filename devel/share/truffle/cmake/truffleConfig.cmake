...
if("TRUE" STREQUAL "TRUE")
  ...
  set(truffle_INSTALL_PREFIX /usr/local)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'truffle' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robot/catkin_ws/src/truffle/${idir}'.  Ask the maintainer 'truffle shuffle <cueva.daniel@yahoo.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/robot/catkin_ws/src/truffle/devel/lib;/home/robot/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
